...
const About = () => {
  return (
    <div>
      <div className="flex min-h-screen items-center bg-white bg-opacity-75">
        <div className="flex-1 max-w-5xl mx-auto bg-white p-10 rounded-xl shadow-xl">
        ...
        <div className="flex-1 max-w-lg mx-auto p-4 flex justify-center items-center">
          <img
      ...
      <div className="bg-gray-100 py-16 text-center">
        <h1 className="text-5xl font-semibold mb-8">Leaders</h1>
